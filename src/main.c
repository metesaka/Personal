...
int main(int argc, char **argv)
{
    ...
    char *replacement_policy_str = "LRU";
    char *endptr;
    size_t cache_size = 32768;
    size_t cache_lines = 2048;
    size_t associativity = 4;



    // OK TODO: calculate the line size and number of sets.
    ...
    enum cache_status a = cache_system->cache_lines->status;
    printf("%s", a);
